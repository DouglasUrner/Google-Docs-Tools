...
DOCUMENT_ID = '1TaxVLCDQ5qSkTzgr8uvJ5DL5E8n_q6ZptTXS7JqTTLQ'
...
store = file.Storage('private/token.json')
creds = store.get()
if not creds or creds.invalid:
    flow = client.flow_from_clientsecrets('private/credentials.json', SCOPES)
